...
public class EditProductActivity extends Activity {
    ...
    private static final String url_product_detials = "http://trackgps.oblgaz.com/app/get_product_details.php";

    // url для обновления продукта
    private static final String url_update_product = "http://trackgps.oblgaz.com/app/update_product.php";

    // url для удаления продукта
    private static final String url_delete_product = "http://trackgps.oblgaz.com/app/delete_product.php";
